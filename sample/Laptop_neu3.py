...
# Wichtig: hier die bereits berechneten Modelle wiederverwenden,
# nicht neu erzeugen.
# ------------------------------------------------------------
...
mm = pyfair.FairMetaModel(
    name='Aggregiertes Risiko',
    models=[baseline_model, comparison_model],
    mode='compare',
    baseline_model=model2.get_name()
)
mm.calculate_all()

# print(mm.export_results().columns.tolist())
# print(mm.calculation_completed())
# print('baseline:', baseline_model.calculation_completed())
# print('comparison:', comparison_model.calculation_completed())
